...
def check_Movie_name(Movie_Name):
    con=sqlite3.connect('C:\\Users\\Dell\\Desktop\\Acadgild\\project\\Movie_recomendtion-System-master\\Movie_Review.db')
    cur=con.cursor()
...
def home():
    ...
    return render_template(r'index.html',posts=json_datafin,message=message,json_headers=json_headers,messages=messages)
        #else:
